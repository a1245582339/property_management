...
exports.getPart = async ctx => {
    ...
    let $selectPart = `select *,part_type.type_name from part left join part_type on part.type_id=part_type.id where isDel="0" ${whereStr ? 'and ' + whereStr : ''} limit ${limit} offset ${page * limit}`
